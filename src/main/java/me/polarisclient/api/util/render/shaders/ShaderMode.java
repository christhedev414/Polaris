package me.polarisclient.api.util.render.shaders;

import me.polarisclient.api.util.render.shaders.shaders.AquaGlShader;
import me.polarisclient.api.util.render.shaders.shaders.AquaShader;
import me.polarisclient.api.util.render.shaders.shaders.BasicShader;
import me.polarisclient.api.util.render.shaders.shaders.FlowGlShader;
import me.polarisclient.api.util.render.shaders.shaders.FlowShader;
import me.polarisclient.api.util.render.shaders.shaders.GangGlShader;
import me.polarisclient.api.util.render.shaders.shaders.GlowShader;
import me.polarisclient.api.util.render.shaders.shaders.HolyFuckShader;
import me.polarisclient.api.util.render.shaders.shaders.PurpleShader;
import me.polarisclient.api.util.render.shaders.shaders.RedShader;
import me.polarisclient.api.util.render.shaders.shaders.SmokeShader;
