...
public abstract class Shader {
   ...
   public Shader(String fragmentShader) {
      ...
      try {
         InputStream vertexStream = this.getClass().getResourceAsStream("/assets/minecraft/textures/polaris/shader/vertex/vert/vertex.vert");
         if (vertexStream != null) {
            vertexShaderID = this.createShader(IOUtils.toString(vertexStream), 35633);
         }

         IOUtils.closeQuietly(vertexStream);
         InputStream fragmentStream = this.getClass().getResourceAsStream("/assets/minecraft/textures/polaris/shader/fragment/frag/" + fragmentShader);
