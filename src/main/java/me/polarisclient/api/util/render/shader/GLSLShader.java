package me.polarisclient.api.util.render.shader;
...
public class GLSLShader {
   ...
   public GLSLShader(String fragmentShaderLocation) throws IOException {
      ...
      GL20.glAttachShader(
         program,
         this.createShader(
            "/assets/minecraft/textures/polaris/shader/vertex/vsh/passthrough.vsh",
            GLSLShader.class.getResourceAsStream("/assets/minecraft/textures/polaris/shader/vertex/vsh/passthrough.vsh"),
            35633
         )
      );
      GL20.glAttachShader(program, this.createShader(fragmentShaderLocation, GLSLShader.class.getResourceAsStream(fragmentShaderLocation), 35632));
