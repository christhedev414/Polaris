...
package me.polarisclient.api.util.render.shader.framebuffer.impl;

import me.polarisclient.api.util.Wrapper;
import me.polarisclient.api.util.render.shader.framebuffer.FramebufferShader;
...
public class ItemShader extends FramebufferShader {
   ...
   public void updateUniforms() {
      ...
      GL20.glUniform2f(
         ...
         1.0F / (float)Wrapper.mc.displayWidth * this.radius * this.quality,
         1.0F / (float)Wrapper.mc.displayHeight * this.radius * this.quality
      );
