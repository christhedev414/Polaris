...
import me.polarisclient.api.events.impl.ConnectionEvent;
import me.polarisclient.api.events.impl.DamageBlockEvent;
import me.polarisclient.api.events.impl.DeathEvent;
...
import me.polarisclient.api.events.impl.RenderFogColorEvent;
import me.polarisclient.api.events.impl.TotemPopEvent;
import me.polarisclient.api.events.impl.UpdateWalkingPlayerEvent;
import me.polarisclient.api.managers.Managers;
import me.polarisclient.api.util.CombatUtil;
import me.polarisclient.api.util.EntityUtil;
import me.polarisclient.api.util.MovementUtil;
...
public class EventManager extends Mod {
   ...
   public void onClientDisconnect(ClientDisconnectionFromServerEvent event) {
      Managers.CONFIGS.saveConfig(Managers.CONFIGS.config.replaceFirst("Polaris/", ""));
   ...
   public void onWorldRender(RenderWorldLastEvent event) {
      if (!fullNullCheck()) {
         if (!event.isCanceled()) {
            Managers.FPS.update();
            mc.profiler.startSection("Polaris");
