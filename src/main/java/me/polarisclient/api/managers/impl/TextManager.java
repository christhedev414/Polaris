...
import me.polarisclient.mod.gui.font.CFont;
import me.polarisclient.mod.gui.font.CustomFont;
...
public class TextManager extends Mod {
   ...
   private final CustomFont iconFont = new CustomFont(new CFont.CustomFont("/assets/minecraft/textures/polaris/fonts/IconFont.ttf", 19.0F, 0), true, false);
