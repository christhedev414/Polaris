...
package me.polarisclient.mod.gui.click;
...
import me.polarisclient.api.util.math.MathUtil;
import me.polarisclient.api.util.render.ColorUtil;
import me.polarisclient.api.util.render.RenderUtil;
import me.polarisclient.mod.Mod;
import me.polarisclient.mod.gui.click.items.Item;
import me.polarisclient.mod.gui.click.items.buttons.Button;
...
public class Component extends Mod {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if (ClickGui.INSTANCE.icon.getValue()) {
         ...
         switch(var15) {
            case "Combat":
               Managers.TEXT
                  .drawStringIcon("b", (float)this.x + 3.0F, (float)this.y - 5.0F - (float)me.polarisclient.mod.gui.screen.Gui.INSTANCE.getTextOffset(), -1);
               break;
            case "Misc":
               Managers.TEXT
                  .drawStringIcon("[", (float)this.x + 3.0F, (float)this.y - 5.0F - (float)me.polarisclient.mod.gui.screen.Gui.INSTANCE.getTextOffset(), -1);
               break;
            case "Render":
               Managers.TEXT
                  .drawStringIcon("a", (float)this.x + 3.0F, (float)this.y - 5.0F - (float)me.polarisclient.mod.gui.screen.Gui.INSTANCE.getTextOffset(), -1);
               break;
            case "Movement":
               Managers.TEXT
                  .drawStringIcon("8", (float)this.x + 3.0F, (float)this.y - 5.0F - (float)me.polarisclient.mod.gui.screen.Gui.INSTANCE.getTextOffset(), -1);
               break;
            case "Player":
               Managers.TEXT
                  .drawStringIcon("5", (float)this.x + 3.0F, (float)this.y - 5.0F - (float)me.polarisclient.mod.gui.screen.Gui.INSTANCE.getTextOffset(), -1);
               break;
            case "Exploit":
               Managers.TEXT
                  .drawStringIcon("!", (float)this.x + 3.0F, (float)this.y - 5.0F - (float)me.polarisclient.mod.gui.screen.Gui.INSTANCE.getTextOffset(), -1);
            ...
            case "HUD":
               Managers.TEXT
                  .drawStringIcon("7", (float)this.x + 3.0F, (float)this.y - 5.0F - (float)me.polarisclient.mod.gui.screen.Gui.INSTANCE.getTextOffset(), -1);
               break;
            case "Dev":
               Managers.TEXT
                  .drawStringIcon("6", (float)this.x + 3.0F, (float)this.y - 5.0F - (float)me.polarisclient.mod.gui.screen.Gui.INSTANCE.getTextOffset(), -1);
         }
      }
      ...
      Managers.TEXT
         .drawStringWithShadow(
            ...
            (float)this.y - 4.0F - (float)me.polarisclient.mod.gui.screen.Gui.INSTANCE.getTextOffset(),
            -1
         );
      if (this.open) {
   ...
   public void drawArrow() {
      ...
      mc.getTextureManager().bindTexture(new ResourceLocation("textures/polaris/arrow.png"));
   ...
   public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
      if (mouseButton == 0 && this.isHovering(mouseX, mouseY)) {
         ...
         me.polarisclient.mod.gui.screen.Gui.INSTANCE.getComponents().forEach(component -> {
            if (component.drag) {
