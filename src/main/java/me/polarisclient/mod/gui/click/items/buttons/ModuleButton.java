...
package me.polarisclient.mod.gui.click.items.buttons;
...
import me.polarisclient.mod.gui.click.Component;
   ...
   public void drawGear() {
      ...
      if (ClickGui.INSTANCE.gear.getValue()) {
         if (future) {
            ...
            mc.getTextureManager().bindTexture(new ResourceLocation("textures/polaris/gear.png"));
            ...
            Managers.TEXT
               .drawStringWithShadow(
                  ...
                  this.y - 2.2F - (float)me.polarisclient.mod.gui.screen.Gui.INSTANCE.getTextOffset(),
                  -1
               );
         }
      }
