...
public class AutoEsu extends Module {
   ...
   private void drawBurrowESP(double x, double y, double z) {
      ...
      if (this.mode.getValue() == AutoEsu.Mode.ShengJie) {
         mc.getTextureManager().bindTexture(new ResourceLocation("textures/polaris/mugshot/shengjie.png"));
      } else if (this.mode.getValue() == AutoEsu.Mode.RuiNan) {
         mc.getTextureManager().bindTexture(new ResourceLocation("textures/polaris/mugshot/ruinan.png"));
      } else if (this.mode.getValue() == AutoEsu.Mode.ShanZhu) {
         mc.getTextureManager().bindTexture(new ResourceLocation("textures/polaris/mugshot/shanzhu.png"));
      }
