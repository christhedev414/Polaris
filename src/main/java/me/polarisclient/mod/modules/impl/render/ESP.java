...
import me.polarisclient.api.util.BlockUtil;
import me.polarisclient.api.util.InterpolationUtil;
...
public class ESP extends Module {
   ...
   private void drawBurrowESP(BlockPos pos) {
      ...
      if (block == Blocks.ENDER_CHEST) {
         mc.getTextureManager().bindTexture(new ResourceLocation("textures/polaris/constant/ingame/echest.png"));
      } else if (block == Blocks.WEB) {
         mc.getTextureManager().bindTexture(new ResourceLocation("textures/polaris/constant/ingame/web.png"));
      } else {
         mc.getTextureManager().bindTexture(new ResourceLocation("textures/polaris/constant/ingame/obby.png"));
      }
