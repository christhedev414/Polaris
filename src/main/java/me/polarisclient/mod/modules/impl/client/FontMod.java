...
import me.polarisclient.api.events.impl.ClientEvent;
...
public class FontMod extends Module {
   ...
   public final Setting<FontMod.Style> style = this.add(new Setting<>("Style", FontMod.Style.PLAIN));
   ...
   public int getFont() {
      switch((FontMod.Style)this.style.getValue()) {
         case BOLD:
            return 1;
         case ITALIC:
            return 2;
